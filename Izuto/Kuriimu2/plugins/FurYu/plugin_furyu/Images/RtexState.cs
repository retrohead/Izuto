...
{
    class RtexState : ILoadFiles, ISaveFiles, IImageFilePluginState
    {
        private readonly Rtex _img = new();
        ...
        public async Task Load(IFileSystem fileSystem, UPath filePath, LoadContext loadContext)
        {
            ...
            _images = [new ImageFile(_img.Load(fileStream), RtexSupport.GetEncodingDefinition())];
        }
