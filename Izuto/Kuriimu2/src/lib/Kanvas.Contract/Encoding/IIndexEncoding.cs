...
namespace Kanvas.Contract.Encoding
{
    ...
    public interface IIndexEncoding : IEncodingInfo
    {
        ...
        IEnumerable<Rgba32> Load(byte[] input, IList<Rgba32> palette, EncodingOptions loadContext);
        ...
        byte[] Save(IEnumerable<int> indices, IList<Rgba32> palette, EncodingOptions saveContext);
    }
}
