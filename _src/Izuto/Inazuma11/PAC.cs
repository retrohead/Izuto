...
namespace Izuto.Inazuma11
{
    public class PAC
    {
        ...
        public static string UpdateString(string InputString, bool alignTo4Bytes)
        {
        ...
        private static void CopyStringBetweenPACS(ref PAC DestPAC, ScriptEntry DestEntry, PAC SourcePAC, ScriptEntry SourceEntry, OptionsFileData? SourceTranslationOptions)
        {
            ...
            DestPAC.StringEntries[destPacIndex].Text = UpdateString(TextTranslation.ConvertTextString(UI_MainWindow.OptionsFile.Config.TranslationTable, sourceText), true);
